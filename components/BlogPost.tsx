...
import { Heart, MessageCircle, Repeat2, Share, Bookmark, MoreHorizontal, Send, User, Send as Telegram, Copy, Link2, Edit, Trash2, Flag, Eye, EyeOff, Loader2 } from 'lucide-react'
