...
const projects: Project[] = [
  {
    ...
    githubUrl: 'https://github.com/makara/ecommerce-platform',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/makara/task-manager',
  ...
  },
  {
    ...
    description: 'A beautiful weather dashboard with forecasts, charts, and location-based weather data.',
    image: 'https://via.placeholder.com/400x300?text=Weather+Dashboard',
    techStack: ['Vue.js', 'Chart.js', 'OpenWeather API', 'SCSS'],
    githubUrl: 'https://github.com/makara/weather-dashboard',
  ...
  },
  {
    ...
    techStack: ['Next.js', 'MDX', 'Prisma', 'NextAuth.js', 'Vercel'],
    githubUrl: 'https://github.com/makara/blog-platform',
  ...
  },
  {
    ...
    githubUrl: 'https://github.com/makara/portfolio',
    liveUrl: 'https://makara.dev',
    featured: true,
  },
  {
    id: '6',
    ...
    techStack: ['React Native', 'Redux', 'Firebase', 'Spoonacular API'],
    githubUrl: 'https://github.com/makara/recipe-finder',
